...
if __name__ == "__main__":
    ...
    parser.add_argument('--min_q_version', default=3, type=int)               # min_q_version = 3 (CQL_kumar(H)), version = 2 (CQL_kumar(rho))
    parser.add_argument('--lagrange_thresh', default=5.0, type=float)         # the value of tau, corresponds to the CQL_kumar(lagrange) version
